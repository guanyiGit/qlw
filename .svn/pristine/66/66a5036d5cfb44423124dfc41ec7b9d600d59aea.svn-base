package com.soholy.dogmanager.common.log;
...
public class SQLFormatter {
    ...
    private static final String pattern = "()+*/-=<>'`\"[],";// "()+*/-=<>'`\"[]" 规则
    ...
    private static class FormatProcess {
        ...
        public FormatProcess(String sql) {
            tokens = new StringTokenizer(sql, pattern + WHITESPACE, true);
        }
    ...
    public static void main(String[] args) {
        String sql = "SELECT " + "di.building,di.creation_time,di.device_category_type,di.device_id,di.device_number,"
                + "di.device_position,di.device_status,di.floor, di.tenant_id,di.usage_place "
                + "FROM t_device_info di " + "WHERE di.device_category_type " + "AND di.device_status = 0";
