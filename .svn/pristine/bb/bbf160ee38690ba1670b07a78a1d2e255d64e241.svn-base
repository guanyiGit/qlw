package com.soholy.dogmanager.common.map;
...
public class Converter {
	...
	private static String key = "97580a2aac84a3c383abdf17352c24ac";
	// 真实地址转高德地址
	public static List<Point> WGS_84GCJ_02(List<Point> points) throws Exception {
		Map<String, String> map = new HashMap<>();
		List<Point> pointList = new ArrayList<>();
		String url = "https://restapi.amap.com/v3/assistant/coordinate/convert";
		String locations = "";
		for (Point point : points) {
			locations += point.getLongitude().toString() + "," + point.getLatitude().toString() + "|";
		}
